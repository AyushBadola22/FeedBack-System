export const TeacherTable = ({ courses, teachers }) => {
            ...
            {(!teachers || teachers.length == 0)  ? (
              ...
              teachers.map((teacher, index) => (
                <tr key={index} className="bg-gray-50" >
                  ...
                  <td className="whitespace-normal border-2 px-6 py-4">{(teacher.section && teacher.section.length > 0) ||  "Not assigned yet"}</td>
                </tr>
              ))
            )}
          </tbody>
